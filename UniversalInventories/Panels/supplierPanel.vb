Public Class supplierPanel
	Private Sub supplierPanel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        If emailValidation() = True Then
            Try
                ...
                SUPPLIERTableAdapter.Update(DSSystem.SUPPLIER)
    ...
    Private Sub searchTxt_TextChanged(sender As Object, e As EventArgs) Handles searchTxt.TextChanged
		SUPPLIERTableAdapter.FillBy(DSSystem.SUPPLIER, searchTxt.Text)
	End Sub

	Private Sub btnInsert_Click(sender As Object, e As EventArgs) Handles btnInsert.Click
        MainForm.displayPanel.Controls.Clear()
        MainForm.insertSupplierPanel = New insertSupplier
        MainForm.displayPanel.Controls.Add(MainForm.insertSupplierPanel)
	End Sub
    ...
    Private Sub txtSearchID_TextChanged(sender As Object, e As EventArgs) Handles txtSearchID.TextChanged
        Try
            If txtSearchID.Text.Equals("") = False Then
                ...
                SUPPLIERTableAdapter.FillBySupplierID(DSSystem.SUPPLIER, s)
            Else
                SUPPLIERTableAdapter.Fill(DSSystem.SUPPLIER)
            End If
        Catch ex As Exception
